...
aws ecr describe-repositories --repository-names ${NARRATIVE_APP_NAME} 2>/dev/null || \
aws ecr create-repository --repository-name ${NARRATIVE_APP_NAME}
...
aws ecs create-cluster \
    --cluster-name $NARRATIVE_CLUSTER_NAME \
...
aws logs create-log-group --log-group-name "/ecs/${NARRATIVE_APP_NAME}" 2>/dev/null || true
